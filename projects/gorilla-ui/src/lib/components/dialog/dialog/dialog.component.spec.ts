...
import { byText, createComponentFactory, Spectator } from '@guiDialog/spectator';
...
describe('DialogComponent', () => {
  ...
  afterEach(() => {
    const containerEls = document.querySelectorAll('.guiDialog-dialog-content');
    const backdropEls = document.querySelectorAll('.guiDialog-dialog-backdrop');
  ...
  describe('when backdrop is enabled', () => {
    ...
    it('should create backdrop div, and set its class', () => {
      expect(spectator.query('.guiDialog-dialog-backdrop')).toBeTruthy();
    });
    ...
    it('backdropClick$ should point to element', () => {
      ...
      spectator.dispatchMouseEvent('.guiDialog-dialog-backdrop', 'click');
  ...
  describe('when backdrop is disabled', () => {
    ...
    it('should create backdrop div, and set its class', () => {
      expect(spectator.query('.guiDialog-dialog-backdrop')).toBeHidden();
    });
  ...
  describe('when enableClose is enabled should call close', () => {
    ...
    it('on click backdrop', () => {
      ...
      spectator.dispatchMouseEvent('.guiDialog-dialog-content', 'click');
  ...
  describe('when draggable is enabled', () => {
    ...
    it('should show draggable marker and instance draggable directive', () => {
      expect(spectator.query('.guiDialog-drag-marker')).toBeTruthy();
  ...
  describe('when draggable is disabled', () => {
    ...
    it('should not show draggable marker and not instance draggable directive', () => {
      expect(spectator.query('.guiDialog-drag-marker')).toBeFalsy();
  ...
  it('when resizable is enabled should set its class', () => {
    ...
    expect(spectator.query('.guiDialog-dialog-resizable')).toBeTruthy();
  });
